...
public class PressBlocks{

    public static final DeferredRegister<Block> BLOCKS = 
        DeferredRegister.create(ForgeRegistries.BLOCKS, MinecraftRpg.MODID);

    public static final RegistryObject<Block> PRESS_BLOCK = registerBlock("press_block", 
        () -> new Block(BlockBehaviour.Properties.copy(Blocks.DIAMOND_BLOCK).strength(3f).requiresCorrectToolForDrops()),
        null);
